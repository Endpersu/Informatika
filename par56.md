...
Ещё одна причина, по которой остаток на аппаратном уровне может быть отрицательным в случае отрицательного делимого, — если бы процессор вычислял правильный остаток, компьютер бы сильно тормозил.
